...
const map = new mapboxgl.Map({
	container: "cluster-map", //this is looking for the ID of the map in your EJS file.
...
map.on("load", () => {
	...
	map.addLayer({
		...
		type: "symbol",
		source: "campgrounds",
		filter: ["has", "point_count"], //to interpolate, do something like "Num: {"has", "point_count"}"
		layout: {
	...
	// the unclustered-point layer, open
	// a popup at
